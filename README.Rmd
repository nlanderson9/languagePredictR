...
This packge implements the analysis described in Dobbins & Kantner 2019. It is intended to quantitatively assess natural language produced by participants, and use language choices to predict binary or continuous outcomes on a given measure.
...
lemmatize - this will reduce words to their base units (e.g. "running" or "ran" becomes "run," "dogs" becomes "dog" and "geese" becomes "goose")
...
```{r}
plot_predictor_words(movie_assessment, topX = 15)
```
